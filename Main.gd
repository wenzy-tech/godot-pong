...
func _ready():
	...
	print("DEBUG V13: _ready done, audio loaded")
...
func spawn_random_powerup():
	...
	powerup_active = true
	powerup_timer = 0.0
	print("DEBUG V13: powerup spawned: ", powerup_type)

func apply_powerup():
	powerup_sound.play()
	print("DEBUG V13: applying powerup: ", powerup_type)
	match powerup_type:
		"speed_up":
...
func reset_powerup_effects():
	...
	pad2_height = 100.0
	ball_radius = 10.0
	print("DEBUG V13: powerup effects reset")
...
func _draw():
	# V13 indicator: 6 circles, first gray
	draw_circle(Vector2(700, 20), 5, Color(0.4, 0.4, 0.4, 1))
