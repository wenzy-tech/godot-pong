...
func _draw():
	...
	draw_circle(ball_position, ball_radius * 1.5, Color(0.0, 0.8, 0.6, 0.25))
	draw_circle(ball_position, ball_radius * 1.2, Color(0.0, 1.0, 0.8, 0.4))
	draw_circle(ball_position, ball_radius, Color(0.0, 1.0, 0.8))
	
	draw_rect(Rect2(10, pad1_pos.y - pad1_height * 0.5, 20, pad1_height), Color(0.2, 0.6, 1.0, 0.3), true, 4)
	draw_rect(Rect2(10, pad1_pos.y - pad1_height * 0.5, 20, pad1_height), Color(0.2, 0.6, 1.0))
	
	draw_rect(Rect2(770, pad2_pos.y - pad2_height * 0.5, 20, pad2_height), Color(1.0, 0.3, 0.5, 0.3), true, 4)
